...
IF 0 = 1--SPLIT
  BEGIN
    ...
    CREATE TABLE [DUMMY].[PostTags] (
      ...
      , CONSTRAINT [PK_PostTags__PostId_Tag] PRIMARY KEY CLUSTERED ( [PostId] ASC,[Tag] ASC ) 
    ) WITH (DATA_COMPRESSION = PAGE);
...
CREATE TABLE [DUMMY].[Posts] (
  ...
  -- INDICES ,CONSTRAINT [IX_Posts_Id_AcceptedAnswerId] UNIQUE NONCLUSTERED ([Id] ASC,[AcceptedAnswerId] ASC ) ,
  -- INDICES CONSTRAINT [IX_Posts_Id_OwnerUserId] UNIQUE NONCLUSTERED ([Id] ASC,[OwnerUserId] ASC ) ,
  -- INDICES CONSTRAINT [IX_Posts_Id_ParentId] UNIQUE NONCLUSTERED ([Id] ASC,[ParentId] ASC ) 
    ) WITH (DATA_COMPRESSION = PAGE);
...
IF 0 = 1--FK
  BEGIN
    ...
    ALTER TABLE [DUMMY].Posts
    ADD CONSTRAINT FK_Posts_PostTypeId__PostTypes_Id FOREIGN KEY (PostTypeId) REFERENCES [DUMMY].PostTypes(Id)
    
    ALTER TABLE [DUMMY].Posts
    ADD CONSTRAINT FK_Posts_ParentId__Posts_Id FOREIGN KEY (ParentId) REFERENCES [DUMMY].Posts(Id)
    
    ALTER TABLE [DUMMY].Posts
    ADD CONSTRAINT FK_Posts_OwnerUserId__Users_Id FOREIGN KEY (OwnerUserId) REFERENCES [DUMMY].Users(Id)
    
    ALTER TABLE [DUMMY].Posts
    ADD CONSTRAINT FK_Posts_AcceptedAnswerId__Posts_Id FOREIGN KEY (AcceptedAnswerId) REFERENCES [DUMMY].Posts(Id)
    
    ALTER TABLE [DUMMY].Comments
    ADD CONSTRAINT FK_Comments_PostId__Posts_Id FOREIGN KEY (PostId) REFERENCES [DUMMY].Posts(Id)
    
    ALTER TABLE [DUMMY].Comments
    ADD CONSTRAINT FK_Comments_UserId__Users_Id FOREIGN KEY (UserId) REFERENCES [DUMMY].Users(Id)
    
	ALTER TABLE [DUMMY].PostHistory
	ADD CONSTRAINT FK_PostHistory_PostId__Posts_Id FOREIGN KEY (PostId) REFERENCES [DUMMY].Posts(Id)

	ALTER TABLE [DUMMY].PostHistory
	ADD CONSTRAINT FK_PostHistory_UserId__Users_Id FOREIGN KEY (UserId) REFERENCES [DUMMY].Users(Id)

	ALTER TABLE [DUMMY].PostHistory
	ADD CONSTRAINT FK_PostHistory_PostHistoryTypeId__PostHistoryTypes_Id FOREIGN KEY (PostHistoryTypeId) REFERENCES [DUMMY].PostHistoryTypes(Id)

    ALTER TABLE [DUMMY].PostLinks
    ADD CONSTRAINT FK_PostLinks_PostId__Posts_Id FOREIGN KEY (PostId) REFERENCES [DUMMY].Posts(Id)
    
    ALTER TABLE [DUMMY].PostLinks
    ADD CONSTRAINT FK_PostLinks_RelatedPostId__Posts_Id FOREIGN KEY (RelatedPostId) REFERENCES [DUMMY].Posts(Id)
    
    ALTER TABLE [DUMMY].PostLinks
    ADD CONSTRAINT FK_PostLinks_LinkTypeId__LinkTypes_Id FOREIGN KEY (LinkTypeId) REFERENCES [DUMMY].LinkTypes(Id)
 IF 0 = 1--SPLIT
  BEGIN
   
    ALTER TABLE [DUMMY].PostTags
    ADD CONSTRAINT FK_PostTags_PostId__Posts_Id FOREIGN KEY (PostId) REFERENCES [DUMMY].Posts(Id)

  END    
    ALTER TABLE [DUMMY].Votes
    ADD CONSTRAINT FK_Votes_PostId__Posts_Id FOREIGN KEY (PostId) REFERENCES [DUMMY].Posts(Id)
    
    ALTER TABLE [DUMMY].Votes
    ADD CONSTRAINT FK_Votes_UserId__Users_Id FOREIGN KEY (UserId) REFERENCES [DUMMY].Users(Id)
    
    ALTER TABLE [DUMMY].Votes
    ADD CONSTRAINT FK_Votes_UserId__VoteTypes_Id FOREIGN KEY (VoteTypeId) REFERENCES [DUMMY].VoteTypes(Id)
